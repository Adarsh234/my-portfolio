...
const About = () => {
  ...
  return (
    <section id="about" className="relative py-24 overflow-hidden cursor-none">
      {/* 🔮 Background Glow */}
      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-10 cursor-none">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: '-100px' }}
          className="flex flex-col items-center text-center cursor-none"
        >
          {/* Header */}
          <motion.div variants={itemVariants} className="mb-8 cursor-none">
            {/* 2. UPDATED H2 WITH REVEALWORD */}
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-800 dark:text-slate-100 tracking-tight mb-6 flex justify-center flex-wrap gap-x-3 gap-y-1 cursor-none">
              <RevealWord delay={0.1}>Behind</RevealWord>
              <RevealWord delay={0.25}>the</RevealWord>
          ...
          <motion.div
            ...
            className="w-full mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 cursor-none"
          >
