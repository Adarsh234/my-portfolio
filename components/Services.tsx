        ...
        <div className="group/services grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, idx) => (
            <motion.div
              ...
              // FIXED: ClassName is now a single line to prevent hydration mismatch
              className="relative transition-all duration-500 ease-out group-hover/services:blur-sm group-hover/services:scale-[0.95] group-hover/services:opacity-60 hover:!blur-none hover:!scale-110 hover:!opacity-100 hover:z-10"
            >
